    ...
    <div className="bg-red-700">
      <div className="pt-20">
        <div className="pt-9 w-[750px] ml-24" style={{ color: "#E8E8E8" }}>
          ...
          <button className="btn bg-white text-red-700 font-bold border-none hover:bg-red-700 hover:text-white mb-20">
            Donate Now
          </button>
        </div>
        <img src={Header1} alt="" className="absolute right-0 top-[160px] w-[515px]" />
      </div>

      <div className="" style={{ backgroundColor: "#E5E5E5" }}>

        <img src={Header2} alt="" className="absolute left-0 top-[570px] w-[423px]" />

        <div className="pt-40 w-[750px] mt-20 ml-[500px]" style={{ color: "#000" }}>
          <h1 className="text-5xl font-bold mb-8">
